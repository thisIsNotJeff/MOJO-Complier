...
public abstract class Absyn {
    ...
    public static abstract class Type extends Node {
        ...
        public static class Proc extends Type {
            ...
            public final Expr.Call.Methods methods;
            public Type result;
            public Proc(Token t, List<Value.Formal> formals, Type result) {
                ...
                this.result = result;
                this.methods = Expr.Call.User.methods;
            }
            public Proc(Expr.Call.Methods methods) {
                super(null);
                this.formals = null;
                this.result = null;
                this.methods = methods;
        ...
        public abstract static class Root {
            public static final Type T = new Object(ID("Root"), null, null, null, null);
            static void init() {
    ...
    public static abstract class Value extends Node {
        ...
        public static class Variable extends Value {
            ...
            public Variable(Formal formal, boolean isOpenArrayType) {
                super(formal.token);
                this.formal = formal;
                ...
                if (isOpenArrayType) indirect(true);
            }
    ...
    public static abstract class Expr extends Node {
        ...
        public static class Call extends Expr {
            ...
            public abstract static class Methods {
                ...
                Methods(int minArgs, int maxArgs, Type fixedType) {
             ...
             */
            public static class User extends Methods {
                private User() { super(0, Integer.MAX_VALUE, null); }
                public <R> R accept(Visitor<R> v) { return v.visit(this); }
                public static final User methods = new User();
            }
            public static class First extends Methods {
                private First() { super(1, 1, null); }
                public <R> R accept(Visitor<R> v) { return v.visit(this); }
                public static final First methods = new First();
                static void init() {
                    Type.Proc t = new Type.Proc(methods);
                    Scope.Insert(new Value.Procedure(ID("First"), t, null));
                    t.checked(true);
                }
            }
            public static class Last extends Methods {
                private Last() { super(1, 1, null); }
                public <R> R accept(Visitor<R> v) { return v.visit(this); }
                public static final Last methods = new Last();
                static void init() {
                    Type.Proc t = new Type.Proc(methods);
            ...
            public static class New extends Methods {
                private New() { super(1, Integer.MAX_VALUE, null); }
                public <R> R accept(Visitor<R> v) { return v.visit(this); }
                public static final New methods = new New();
                static void init() {
                    Type.Proc t = new Type.Proc(methods);
            ...
            public static class Number extends Methods {
                private Number() { super(1, 1, Type.Int.T); }
                public <R> R accept(Visitor<R> v) { return v.visit(this); }
                public static final Number methods = new Number();
                static void init() {
                    Type.Proc t = new Type.Proc(methods);
    ...
    public static void addMember(Value member, List fields, List methods, List overrides) {
        if (member instanceof Value.Field) fields.add(member);
        else if (member instanceof Value.Method) {
            Value.Method temp = (Value.Method) member;
            if (temp.sig == null) {
